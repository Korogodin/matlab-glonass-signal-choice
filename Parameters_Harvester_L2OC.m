...
% Усеченное множество сигналов L2OC
load([path_to_results_dir '/clipping/Signals_BOCsin_L2OC.mat'], 'Signals_BOCsin_L2OC');
load([path_to_results_dir '/clipping/Signals_BOCcos_L2OC.mat'], 'Signals_BOCcos_L2OC');
load([path_to_results_dir '/clipping/Signals_BPSK_L2OC.mat'], 'Signals_BPSK_L2OC')
size_BOCsin = size(Signals_BOCsin_L2OC, 1)*(~isnan(Signals_BOCsin_L2OC(1,1)));
size_BOCcos = size(Signals_BOCcos_L2OC, 1)*(~isnan(Signals_BOCcos_L2OC(1,1)));
size_BPSK = size(Signals_BPSK_L2OC, 1)*(~isnan(Signals_BPSK_L2OC(1,1)));
...
Qual_BoCsin_L2OC = nan(m8max, n8max, fmax, qual_max);
save([path_to_prop '/Qual_BoCsin_L2OC.mat'], 'Qual_BoCsin_L2OC');
Qual_BoCcos_L2OC = nan(m8max, n8max, fmax, qual_max);
save([path_to_prop '/Qual_BoCcos_L2OC.mat'], 'Qual_BoCcos_L2OC');
Qual_BPSK_L2OC = nan(n8max, fmax, qual_max);
save([path_to_prop '/Qual_BPSK_L2OC.mat'], 'Qual_BPSK_L2OC');

constants;

load([path_to_prop '/Qual_BoCsin_L2OC.mat'], 'Qual_BoCsin_L2OC');
load([path_to_prop '/Qual_BoCcos_L2OC.mat'], 'Qual_BoCcos_L2OC');
load([path_to_prop '/Qual_BPSK_L2OC.mat'], 'Qual_BPSK_L2OC');
...
max_Search = - 99999;
for i = 1:size_BOCsin
    n = Signals_BOCsin_L2OC(i, 2); n8 = n*8;
    m = Signals_BOCsin_L2OC(i, 1); m8 = m*8;
    if max_Search < AcqBOC(n8)
        max_Search = AcqBOC(n8);
    end
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        if max_Search < AcqBOC(n8)
            max_Search = AcqBOC(n8);
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
...
for i = 1:size_BOCsin
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L2OC(m8, n8, freq_index, Search) = resrec;
    end
end
    for i = 1:size_BOCcos
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        resrec = recalc_threshold(AcqBOC(n8), ntmin, ntmax, min_Search, max_Search);
        for freq_index = 1:fmax
            Qual_BoCcos_L2OC(m8, n8, freq_index, Search) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L2OC(n8, freq_index, Search) = resrec;
                end
            end
        end
...
for i = 1:size_BOCsin
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L2OC(m8, n8, freq_index, MP) = resrec;
    end
end
    for i = 1:size_BOCcos
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L2OC(m8, n8, freq_index, MP) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L2OC(n8, freq_index, MP) = resrec;
                end
            end
        end
...
for i = 1:size_BOCsin
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L2OC(m8, n8, freq_index, IntraS) = resrec;
    end
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L2OC(m8, n8, freq_index, IntraS) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L2OC(n8, freq_index, IntraS) = resrec;
                end
            end
        end
...
for i = 1:size_BOCsin
    ...
    Qual_BoCsin_L2OC(m8, n8, freq_index, Compl) = resrec;
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L2OC(m8, n8, freq_index, Compl) = resrec;
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L2OC(n8, freq_index, Compl) = resrec;
            end
        end
...
for i = 1:size_BOCsin
    ...
    Qual_BoCsin_L2OC(m8, n8, freq_index, InterNam) = resrec;
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L2OC(m8, n8, freq_index, InterNam) = resrec;
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L2OC(n8, freq_index, InterNam) = resrec;
            end        
        end
...
for i = 1:size_BOCsin
    ...
    Qual_BoCsin_L2OC(m8, n8, freq_index, InterIm) = resrec;
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L2OC(m8, n8, freq_index, InterIm) = resrec;
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L2OC(n8, freq_index, InterIm) = resrec;
            end   
        end
...
for i = 1:size_BOCsin
    ...
    for i = 1:size_BOCcos
        ...
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
                m = Signals_BPSK_L2OC(i, 1); m8 = m*8; % = 0
                freq = Signals_BPSK_L2OC(i, 3);
                freq_index = freq - farr(1) + 1;    
...
for i = 1:size_BOCsin
    ...
    Qual_BoCsin_L2OC(m8, n8, freq_index, RA) = resrec;
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L2OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L2OC(m8, n8, freq_index, RA) = resrec;
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                n = Signals_BPSK_L2OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L2OC(n8, freq_index, RA) = resrec;
            end
        end
...
for i = 1:size_BOCsin
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L2OC(m8, n8, freq_index, Accur) = resrec;
    end
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L2OC(m8, n8, freq_index, Accur) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))    
            for i = 1:size_BPSK
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L2OC(n8, freq_index, Accur) = resrec;
                end
            end   
        end
...
for i = 1:size_BOCsin
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L2OC(m8, n8, freq_index, Pomex) = resrec;
    end
end
    for i = 1:size_BOCcos
        n = Signals_BOCcos_L2OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L2OC(m8, n8, freq_index, Pomex) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L2OC(1,1))    
            for i = 1:size_BPSK
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L2OC(n8, freq_index, Pomex) = resrec;
                end
            end   
        end
...
All_Signals_index = 0;
    ...
    if Table_Type == 1
        fprintf('|+ Multi-objective optimization for L2OC signal\n');
    elseif Table_Type == 2
        if TopSize < All_Signals_Size
            fprintf('|+ Multi-objective optimization for L2OC signal (Top %.0f)\n', TopSize);
        else
...
for i = 1:size_BOCsin
    ...
    if Table_Type == 1
        ...
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Pomex));
%         fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, RA));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Accur));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, MP));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, InterNam));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, InterIm));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Search));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Compl));
        fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, IntraS));
    end
    
    norm_s = norm_s + (C_Pomex_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, Pomex))^2;
%     norm_s = norm_s + (C_RA_OC*Qual_BoCsin_L2OC(m8, n8, freq_index,
%     RA))^2;
    norm_s = norm_s + (C_Accur_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, Accur))^2;
    norm_s = norm_s + (C_MP_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, MP))^2;
    norm_s = norm_s + (C_InterNam_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, InterNam))^2;
    norm_s = norm_s + (C_InterIm_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, InterIm))^2;
    norm_s = norm_s + (C_Search_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, Search))^2;
    norm_s = norm_s + (C_Compl_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, Compl))^2;
    norm_s = norm_s + (C_IntraS_OC*Qual_BoCsin_L2OC(m8, n8, freq_index, IntraS))^2;
...
%         sqrt(norm_s)
    ...
    for i = 1:size_BOCcos
        ...
        if Table_Type == 1
            ...
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Pomex));
%             fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, RA));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Accur));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, MP));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, InterNam));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, InterIm));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Search));
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Compl));        
            fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, IntraS));
        end
        
        norm_s = norm_s + (C_Pomex_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, Pomex))^2;
%         norm_s = norm_s + (C_RA_OC*Qual_BoCcos_L2OC(m8, n8, freq_index,
%         RA))^2;        
        norm_s = norm_s + (C_Accur_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, Accur))^2;
        norm_s = norm_s + (C_MP_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, MP))^2;
        norm_s = norm_s + (C_InterNam_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, InterNam))^2;
        norm_s = norm_s + (C_InterIm_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, InterIm))^2;
        norm_s = norm_s + (C_Search_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, Search))^2;
        norm_s = norm_s + (C_Compl_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, Compl))^2;
        norm_s = norm_s + (C_IntraS_OC*Qual_BoCcos_L2OC(m8, n8, freq_index, IntraS))^2;
        ...
        if ~isnan(Signals_BPSK_L2OC(1,1))
            for i = 1:size_BPSK
                ...
                if Table_Type == 1
                    ...
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Pomex));
%                     fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, RA));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Accur));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, MP));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, InterNam));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, InterIm));                
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Search));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Compl));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, IntraS));
                end
                
                norm_s = norm_s + (C_Pomex_OC*Qual_BPSK_L2OC(n8, freq_index, Pomex))^2;
%                 norm_s = norm_s + (C_RA_OC*Qual_BPSK_L2OC(n8, freq_index, RA))^2;
                norm_s = norm_s + (C_Accur_OC*Qual_BPSK_L2OC(n8, freq_index, Accur))^2;
                norm_s = norm_s + (C_MP_OC*Qual_BPSK_L2OC(n8, freq_index, MP))^2;
                norm_s = norm_s + (C_InterNam_OC*Qual_BPSK_L2OC(n8, freq_index, InterNam))^2;
                norm_s = norm_s + (C_InterIm_OC*Qual_BPSK_L2OC(n8, freq_index, InterIm))^2;
                norm_s = norm_s + (C_Search_OC*Qual_BPSK_L2OC(n8, freq_index, Search))^2;
                norm_s = norm_s + (C_Compl_OC*Qual_BPSK_L2OC(n8, freq_index, Compl))^2;
                norm_s = norm_s + (C_IntraS_OC*Qual_BPSK_L2OC(n8, freq_index, IntraS))^2;
...
if Table_Type == 2        
    ...
    for j = 1:(TopSize)
        ...
        if All_Signals_Norm_b(j) <= size_BOCsin
            ...
            fprintf('|BOC<sub>sin</sub>(%.3f, %.3f) at %.0f<math>f_b</math> ', m, n, freq);
            fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Pomex));
%             fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index,
%             RA));
            fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, Accur));
            fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, MP));
            fprintf('|| %.3f ', Qual_BoCsin_L2OC(m8, n8, freq_index, InterNam));
        ...
        elseif All_Signals_Norm_b(j) <= (size_BOCsin + size_BOCcos)
                ...
                fprintf('|BoC<sub>cos</sub>(%.3f, %.3f) at %.0f<math>f_b</math> ', m, n, freq);
                fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Pomex));
%                 fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index,
%                 RA));
                fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, Accur));
                fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, MP));
                fprintf('|| %.3f ', Qual_BoCcos_L2OC(m8, n8, freq_index, InterNam));
                ...
                fprintf('|| %.4f ', All_Signals_Norm( All_Signals_Norm_b(j) ));
                    ...
                    fprintf('|BPSK(%.3f) at %.0f<math>f_b</math> ', n, freq);
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Pomex));
%                     fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index,
%                     RA));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, Accur));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, MP));
                    fprintf('|| %.3f ', Qual_BPSK_L2OC(n8, freq_index, InterNam));
