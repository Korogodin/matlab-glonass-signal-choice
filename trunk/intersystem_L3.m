...
% InterSysJam_BoCsin_L3_BoC_0_10 = nan(m8max, n8max, fmax);
% InterSysJam_BoCcos_L3_BoC_0_10 = nan(m8max, n8max, fmax);
% InterSysJam_BPSK_L3_BoC_0_10 = nan(n8max, fmax);
% save([path_to_results '/InterSysJam_BoCsin_L3_BoC_0_10.mat'], 'InterSysJam_BoCsin_L3_BoC_0_10');
% save([path_to_results '/InterSysJam_BoCcos_L3_BoC_0_10.mat'], 'InterSysJam_BoCcos_L3_BoC_0_10');
% save([path_to_results '/InterSysJam_BPSK_L3_BoC_0_10.mat'], 'InterSysJam_BPSK_L3_BoC_0_10');
...
f_intro = 1176.45e6; % Частота мешающих сигналов
...
%                     continue;
            ...
            if (N_ro_old ~= N_ro)||(f_index_old ~= f_index)||(Hd_old ~= Hd)
                % Конвертер частоты
            ...
            if Signal_Type == BOCsin 
                InterSysJam_BoCsin_L3_BoC_0_10(m8, n8, f_index) = Inte_GPS_BoC_0_10;
            elseif Signal_Type == BOCcos
                InterSysJam_BoCcos_L3_BoC_0_10(m8, n8, f_index) = Inte_GPS_BoC_0_10;
            elseif Signal_Type == BPSK
                InterSysJam_BPSK_L3_BoC_0_10(n8, f_index) = Inte_GPS_BoC_0_10;
            end
...
%     hF = figure(hF+1);
%     if (Signal_Type == BOCsin)
%         pcolor((1:80)/8, (1:80)/8, InterSysJam_BoCsin_L3_BoC_0_10(1:80,1:80, i));
%         xlabel('n')
%         ylabel('m')
%     elseif (Signal_Type == BOCcos)
%         pcolor((1:80)/8, (1:80)/8, InterSysJam_BoCcos_L3_BoC_0_10(1:80,1:80, i));
%         xlabel('n')
%         ylabel('m')
%     elseif (Signal_Type == BPSK)
%         plot((1:80)/8, InterSysJam_BPSK_L3_BoC_0_10(1:80, i));        
%         xlabel('n')
%         ylabel('k_cd')
%     end
...
hF = figure(hF + 1);
plot(1:N_ro, ro_our, 1:N_ro_1, ro_GPS_BoC_0_10, 1:N_ro_1, ro_GPS_BoC_0_10.*cos_df, ...
     1:N_ro_dop, ro_our_f, 1:N_ro_dop, ro_GPS_BoC_0_10_dop_f);
title('All')
...
plot(ff_dop, (abs(fftshift(fft(ro_our_dop)))), ...
     ...
     ff_dop, abs((fftshift(fft(ro_GPS_BoC_0_10_dop.*cos_df_dop)))), ...
...
hF = figure(hF + 1);
maxx = max(10*log10(abs((fftshift(fft(ro_GPS_BoC_0_10_dop.*cos_df_dop))))));
