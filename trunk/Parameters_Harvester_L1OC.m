...
% Усеченное множество сигналов L1OC
...
Qual_BoCsin_L1OC = nan(m8max, n8max, fmax, qual_max);
save([path_to_prop '/Qual_BoCsin_L1OC.mat'], 'Qual_BoCsin_L1OC');
Qual_BoCcos_L1OC = nan(m8max, n8max, fmax, qual_max);
save([path_to_prop '/Qual_BoCcos_L1OC.mat'], 'Qual_BoCcos_L1OC');
Qual_BPSK_L1OC = nan(n8max, fmax, qual_max);
save([path_to_prop '/Qual_BPSK_L1OC.mat'], 'Qual_BPSK_L1OC');

constants;

load([path_to_prop '/Qual_BoCsin_L1OC.mat'], 'Qual_BoCsin_L1OC');
load([path_to_prop '/Qual_BoCcos_L1OC.mat'], 'Qual_BoCcos_L1OC');
load([path_to_prop '/Qual_BPSK_L1OC.mat'], 'Qual_BPSK_L1OC');
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L1OC(m8, n8, freq_index, Search) = resrec;
    end
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        m = Signals_BOCcos_L1OC(i, 1); m8 = m*8;
        ...
        resrec = recalc_threshold(AcqBOC(n8), ntmin, ntmax, min_Search, max_Search);
        for freq_index = 1:fmax
            Qual_BoCcos_L1OC(m8, n8, freq_index, Search) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L1OC(n8, freq_index, Search) = resrec;
                end
            end
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L1OC(m8, n8, freq_index, IntraS) = resrec;
    end
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L1OC(m8, n8, freq_index, IntraS) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L1OC(n8, freq_index, IntraS) = resrec;
                end
            end
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    Qual_BoCsin_L1OC(m8, n8, freq_index, Compl) = resrec;
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L1OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L1OC(m8, n8, freq_index, Compl) = resrec;
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                n = Signals_BPSK_L1OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L1OC(n8, freq_index, Compl) = resrec;
            end
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    Qual_BoCsin_L1OC(m8, n8, freq_index, InterNam) = resrec;
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L1OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L1OC(m8, n8, freq_index, InterNam) = resrec;
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                n = Signals_BPSK_L1OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L1OC(n8, freq_index, InterNam) = resrec;
            end        
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    Qual_BoCsin_L1OC(m8, n8, freq_index, InterIm) = resrec;
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L1OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L1OC(m8, n8, freq_index, InterIm) = resrec;
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                n = Signals_BPSK_L1OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L1OC(n8, freq_index, InterIm) = resrec;
            end   
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        ...
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                n = Signals_BPSK_L1OC(i, 2); n8 = n*8;
                m = Signals_BPSK_L1OC(i, 1); m8 = m*8; % = 0
                freq = Signals_BPSK_L1OC(i, 3);
                freq_index = freq - farr(1) + 1;    
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    Qual_BoCsin_L1OC(m8, n8, freq_index, RA) = resrec;
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        m = Signals_BOCcos_L1OC(i, 1); m8 = m*8;
        ...
        Qual_BoCcos_L1OC(m8, n8, freq_index, RA) = resrec;
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))
            for i = 1:size(Signals_BPSK_L1OC, 1)
                n = Signals_BPSK_L1OC(i, 2); n8 = n*8;
                ...
                Qual_BPSK_L1OC(n8, freq_index, RA) = resrec;
            end
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L1OC(m8, n8, freq_index, Accur) = resrec;
    end
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L1OC(m8, n8, freq_index, Accur) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))    
            for i = 1:size(Signals_BPSK_L1OC, 1)
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L1OC(n8, freq_index, Accur) = resrec;
                end
            end   
        end
...
for i = 1:size(Signals_BOCsin_L1OC, 1)
    ...
    for freq_index = 1:fmax
        Qual_BoCsin_L1OC(m8, n8, freq_index, Pomex) = resrec;
    end
end
    for i = 1:size(Signals_BOCcos_L1OC, 1)
        n = Signals_BOCcos_L1OC(i, 2); n8 = n*8;
        ...
        for freq_index = 1:fmax
            Qual_BoCcos_L1OC(m8, n8, freq_index, Pomex) = resrec;
        end
    end
        if ~isnan(Signals_BPSK_L1OC(1,1))    
            for i = 1:size(Signals_BPSK_L1OC, 1)
                ...
                for freq_index = 1:fmax
                    Qual_BPSK_L1OC(n8, freq_index, Pomex) = resrec;
                end
            end   
        end
