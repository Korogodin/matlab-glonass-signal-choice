...
% Empty file creation
% InterSysJam_BoCsin_L2_GloST = nan(m8max, n8max, fmax, lit_size);
% InterSysJam_BoCcos_L2_GloST = nan(m8max, n8max, fmax, lit_size);
% save([path_to_results '/InterSysJam_BoCsin_L2_GloST.mat'], 'InterSysJam_BoCsin_L2_GloST');
% save([path_to_results '/InterSysJam_BoCcos_L2_GloST.mat'], 'InterSysJam_BoCcos_L2_GloST');
% InterSysJam_BoCsin_L2_GloVT = nan(m8max, n8max, fmax, lit_size);
% InterSysJam_BoCcos_L2_GloVT = nan(m8max, n8max, fmax, lit_size);
% save([path_to_results '/InterSysJam_BoCsin_L2_GloVT.mat'], 'InterSysJam_BoCsin_L2_GloVT');
% save([path_to_results '/InterSysJam_BoCcos_L2_GloVT.mat'], 'InterSysJam_BoCcos_L2_GloVT');
% InterSysJam_BPSK_L2_GloST = nan(n8max, fmax, lit_size);
% InterSysJam_BPSK_L2_GloVT = nan(n8max, fmax, lit_size);
% save([path_to_results '/InterSysJam_BPSK_L2_GloST.mat'], 'InterSysJam_BPSK_L2_GloST');
% save([path_to_results '/InterSysJam_BPSK_L2_GloVT.mat'], 'InterSysJam_BPSK_L2_GloVT');
% 
% InterSysJam_BoCsin_L2_GloST_mean = nan(m8max, n8max, fmax);
% InterSysJam_BoCcos_L2_GloST_mean = nan(m8max, n8max, fmax);
% save([path_to_results '/InterSysJam_BoCsin_L2_GloST_mean.mat'], 'InterSysJam_BoCsin_L2_GloST_mean');
% save([path_to_results '/InterSysJam_BoCcos_L2_GloST_mean.mat'], 'InterSysJam_BoCcos_L2_GloST_mean');
% InterSysJam_BoCsin_L2_GloVT_mean = nan(m8max, n8max, fmax);
% InterSysJam_BoCcos_L2_GloVT_mean = nan(m8max, n8max, fmax);
% save([path_to_results '/InterSysJam_BoCsin_L2_GloVT_mean.mat'], 'InterSysJam_BoCsin_L2_GloVT_mean');
% save([path_to_results '/InterSysJam_BoCcos_L2_GloVT_mean.mat'], 'InterSysJam_BoCcos_L2_GloVT_mean');
% InterSysJam_BPSK_L2_GloST_mean = nan(n8max, fmax);
% InterSysJam_BPSK_L2_GloVT_mean = nan(n8max, fmax);
% save([path_to_results '/InterSysJam_BPSK_L2_GloST_mean.mat'], 'InterSysJam_BPSK_L2_GloST_mean');
% save([path_to_results '/InterSysJam_BPSK_L2_GloVT_mean.mat'], 'InterSysJam_BPSK_L2_GloVT_mean');


% Load files
load([path_to_results '/InterSysJam_BoCsin_L2_GloST.mat'], 'InterSysJam_BoCsin_L2_GloST');
load([path_to_results '/InterSysJam_BoCcos_L2_GloST.mat'], 'InterSysJam_BoCcos_L2_GloST');
load([path_to_results '/InterSysJam_BoCsin_L2_GloVT.mat'], 'InterSysJam_BoCsin_L2_GloVT');
load([path_to_results '/InterSysJam_BoCcos_L2_GloVT.mat'], 'InterSysJam_BoCcos_L2_GloVT');
load([path_to_results '/InterSysJam_BPSK_L2_GloST.mat'], 'InterSysJam_BPSK_L2_GloST');
load([path_to_results '/InterSysJam_BPSK_L2_GloVT.mat'], 'InterSysJam_BPSK_L2_GloVT');
        ...
        for m8 = 1:80     
            ...
            for lit_index = 1:lit_size
                ...
                if Signal_Type == BOCsin 
                    if (~isnan(InterSysJam_BoCsin_L2_GloST(m8, n8, f_index, lit_index))) && ...
                            (~isnan(InterSysJam_BoCsin_L2_GloVT(m8, n8, f_index, lit_index)))
                        do_out = 0;
                        break;
                    end
                elseif Signal_Type == BOCcos
                    if (~isnan(InterSysJam_BoCcos_L2_GloST(m8, n8, f_index, lit_index))) && ...
                            (~isnan(InterSysJam_BoCcos_L2_GloVT(m8, n8, f_index, lit_index)))
                        do_out = 0;
                        break;
                    end
                elseif Signal_Type == BPSK
                    if (~isnan(InterSysJam_BPSK_L2_GloST(n8, f_index, lit_index))) && ...
                            (~isnan(InterSysJam_BPSK_L2_GloVT(n8, f_index, lit_index)))
                        do_out = 0;
                        break;
                    end                
                end
...
%                 cos_df_dop = cos(2*pi*dFreq*( (1:N_ro_dop) - ((N_ro - 1)/2 + 1) )*Td); % Дополненный справа
        ...
        %         Inte = ro_our*(ro_GPS_BoC_1_1.*cos_df)'*Td;
                ...
                if Signal_Type == BOCsin 
                    InterSysJam_BoCsin_L2_GloST(m8, n8, f_index, lit_index) = Inte_Glo_ST;
                    InterSysJam_BoCsin_L2_GloVT(m8, n8, f_index, lit_index) = Inte_Glo_VT;
                elseif Signal_Type == BOCcos
                    InterSysJam_BoCcos_L2_GloST(m8, n8, f_index, lit_index) = Inte_Glo_ST;
                    InterSysJam_BoCcos_L2_GloVT(m8, n8, f_index, lit_index) = Inte_Glo_VT;
                elseif Signal_Type == BPSK
                    InterSysJam_BPSK_L2_GloST(n8, f_index, lit_index) = Inte_Glo_ST;
                    InterSysJam_BPSK_L2_GloVT(n8, f_index, lit_index) = Inte_Glo_VT;
                end
            ...
            if do_out 
                ...
                if Signal_Type == BOCsin 
                    InterSysJam_BoCsin_L2_GloST_mean(m8, n8, f_index) = Inte_Glo_ST_mean;
                    InterSysJam_BoCsin_L2_GloVT_mean(m8, n8, f_index) = Inte_Glo_VT_mean;
                elseif Signal_Type == BOCcos
                    InterSysJam_BoCcos_L2_GloST_mean(m8, n8, f_index) = Inte_Glo_ST_mean;
                    InterSysJam_BoCcos_L2_GloVT_mean(m8, n8, f_index) = Inte_Glo_VT_mean;
                elseif Signal_Type == BPSK
                    InterSysJam_BPSK_L2_GloST_mean(n8, f_index) = Inte_Glo_ST_mean;
                    InterSysJam_BPSK_L2_GloVT_mean(n8, f_index) = Inte_Glo_VT_mean;
                end        
            end
...
for i = 1:fmax
    hF = figure(hF+1);
    if (Signal_Type == BOCsin)
        pcolor((1:80)/8, (1:80)/8, InterSysJam_BoCsin_L2_GloST_mean(1:80,1:80, i));
        xlabel('n')
        ylabel('m')
    elseif (Signal_Type == BOCcos)
        pcolor((1:80)/8, (1:80)/8, InterSysJam_BoCcos_L2_GloST_mean(1:80,1:80, i));
        xlabel('n')
        ylabel('m')
    elseif (Signal_Type == BPSK)
        plot((1:80)/8, InterSysJam_BPSK_L2_GloST_mean(1:80, i));        
        xlabel('n')
        ylabel('k_cd')
    end
