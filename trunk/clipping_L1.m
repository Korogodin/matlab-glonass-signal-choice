...
path_to_results_back_inter_C = [pwd '/results/back_intersystem_L1/Common'];
load([path_to_results_back_inter_C '/BackInterSysJam_BoCsin_L1.mat'], 'BackInterSysJam_BoCsin_L1');
load([path_to_results_back_inter_C '/BackInterSysJam_BoCcos_L1.mat'], 'BackInterSysJam_BoCcos_L1');
load([path_to_results_back_inter_C '/BackInterSysJam_BPSK_L1.mat'], 'BackInterSysJam_BPSK_L1');
...
for Access_Type = 2:2
    ...
    if Access_Type == OpenSignal
        fprintf('|+ L1 open signals after clipping \n');
    ...
    elseif Access_Type == CloseSignal
        fprintf('|+ L1 special signals after clipping \n');
                                    ...
                                    if Complexity_BoCsin(m8, n8, freq_index) <= Threshold_Complexity
                                        if ((m+n + farr(freq_index)) <= (farr(end) + 1)) && ((farr(freq_index) - (m+n)) >= (farr(1) - 1))...
                                            ...
                                            if (Access_Type == OpenSignal)||(n == 2.5)||(n == 2.25)||(n == 2.625)||(n == n)
                                                ...
                                                if WideTable
                                                    fprintf('|| %.1f ', BackInterSysJam_BoCsin_L1(m8, n8, freq_index));
                                                    fprintf('|| %.1f ', InterSysJam_BoCsin_L1(m8, n8, freq_index));
                                    ...
                                    if Complexity_BoCcos(m8, n8, freq_index) <= Threshold_Complexity
                                        if ((m+n + farr(freq_index)) <= (farr(end) + 1)) && ((farr(freq_index) - (m+n)) >= (farr(1) - 1))...
                                            ...
                                            if (Access_Type == OpenSignal)||(n == 2.5)||(n == 2.25)||(n == 2.625)||(n == n)
                                                ...
                                                if WideTable
                                                    fprintf('|| %.1f ', BackInterSysJam_BoCcos_L1(m8, n8, freq_index));
                                                    fprintf('|| %.1f ', InterSysJam_BoCcos_L1(m8, n8, freq_index));
                                    ...
                                    if Complexity_BPSK(n8, freq_index) <= Threshold_Complexity
                                        if ((m+n + farr(freq_index)) <= (farr(end) + 1)) && ((farr(freq_index) - (m+n)) >= (farr(1) - 1))...
                                            ...
                                            if (Access_Type == OpenSignal)||(n == 2.5)||(n == 2.25)||(n == 2.625)||(n == n)
                                                ...
                                                if WideTable
                                                    fprintf('|| %.1f ', BackInterSysJam_BPSK_L1(n8, freq_index));
                                                    fprintf('|| %.1f ', InterSysJam_BPSK_L1(n8, freq_index));
