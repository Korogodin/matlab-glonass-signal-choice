...
% BackInterSysJam_BoCsin_L2_BoC_10_5 = nan(m8max, n8max, fmax);
% BackInterSysJam_BoCcos_L2_BoC_10_5 = nan(m8max, n8max, fmax);
% BackInterSysJam_BPSK_L2_BoC_10_5 = nan(n8max, fmax);
% save([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_10_5.mat'], 'BackInterSysJam_BoCsin_L2_BoC_10_5');
% save([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_10_5.mat'], 'BackInterSysJam_BoCcos_L2_BoC_10_5');
% save([path_to_results '/BackInterSysJam_BPSK_L2_BoC_10_5.mat'], 'BackInterSysJam_BPSK_L2_BoC_10_5');
% 
% BackInterSysJam_BoCsin_L2_BoC_0_1 = nan(m8max, n8max, fmax);
% BackInterSysJam_BoCcos_L2_BoC_0_1 = nan(m8max, n8max, fmax);
% BackInterSysJam_BPSK_L2_BoC_0_1 = nan(n8max, fmax);
% save([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_0_1.mat'], 'BackInterSysJam_BoCsin_L2_BoC_0_1');
% save([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_0_1.mat'], 'BackInterSysJam_BoCcos_L2_BoC_0_1');
% save([path_to_results '/BackInterSysJam_BPSK_L2_BoC_0_1.mat'], 'BackInterSysJam_BPSK_L2_BoC_0_1');
% 
% BackInterSysJam_BoCsin_L2_BoC_0_10 = nan(m8max, n8max, fmax);
% BackInterSysJam_BoCcos_L2_BoC_0_10 = nan(m8max, n8max, fmax);
% BackInterSysJam_BPSK_L2_BoC_0_10 = nan(n8max, fmax);
% save([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_0_10.mat'], 'BackInterSysJam_BoCsin_L2_BoC_0_10');
% save([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_0_10.mat'], 'BackInterSysJam_BoCcos_L2_BoC_0_10');
% save([path_to_results '/BackInterSysJam_BPSK_L2_BoC_0_10.mat'], 'BackInterSysJam_BPSK_L2_BoC_0_10');
% return

load([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_10_5.mat']);
load([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_10_5.mat']);
load([path_to_results '/BackInterSysJam_BPSK_L2_BoC_10_5.mat']);
load([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_0_1.mat']);
load([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_0_1.mat']);
load([path_to_results '/BackInterSysJam_BPSK_L2_BoC_0_1.mat']);
load([path_to_results '/BackInterSysJam_BoCsin_L2_BoC_0_10.mat']);
load([path_to_results '/BackInterSysJam_BoCcos_L2_BoC_0_10.mat']);
load([path_to_results '/BackInterSysJam_BPSK_L2_BoC_0_10.mat']);
...
f_intro = 1227.6e6; % Частота рассматриваемых сигналов (теперь полезных)
...
%         for m8 = 40               
            ...
            if Signal_Type == BOCsin 
                if (~isnan(BackInterSysJam_BoCsin_L2_BoC_10_5(m8, n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BoCsin_L2_BoC_0_1(m8, n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BoCsin_L2_BoC_0_10(m8, n8, f_index)))
                    continue;
                end
            elseif Signal_Type == BOCcos
                if (~isnan(BackInterSysJam_BoCcos_L2_BoC_10_5(m8, n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BoCcos_L2_BoC_0_1(m8, n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BoCcos_L2_BoC_0_10(m8, n8, f_index)))
                    continue;
                end
            elseif Signal_Type == BPSK
                if (~isnan(BackInterSysJam_BPSK_L2_BoC_10_5(n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BPSK_L2_BoC_0_1(n8, f_index))) && ...
                        (~isnan(BackInterSysJam_BPSK_L2_BoC_0_10(n8, f_index)))
                    continue;
                end                
            end
            ...
            if Signal_Type == BOCsin 
                BackInterSysJam_BoCsin_L2_BoC_10_5(m8, n8, f_index) = Inte_GPS_BoC_10_5;
                BackInterSysJam_BoCsin_L2_BoC_0_1(m8, n8, f_index) = Inte_GPS_BoC_0_1;
                BackInterSysJam_BoCsin_L2_BoC_0_10(m8, n8, f_index) = Inte_GPS_BoC_0_10;
            elseif Signal_Type == BOCcos
                BackInterSysJam_BoCcos_L2_BoC_10_5(m8, n8, f_index) = Inte_GPS_BoC_10_5;
                BackInterSysJam_BoCcos_L2_BoC_0_1(m8, n8, f_index) = Inte_GPS_BoC_0_1;
                BackInterSysJam_BoCcos_L2_BoC_0_10(m8, n8, f_index) = Inte_GPS_BoC_0_10;
            elseif Signal_Type == BPSK
                BackInterSysJam_BPSK_L2_BoC_10_5(n8, f_index) = Inte_GPS_BoC_10_5;
                BackInterSysJam_BPSK_L2_BoC_0_1(n8, f_index) = Inte_GPS_BoC_0_1;
                BackInterSysJam_BPSK_L2_BoC_0_10(n8, f_index) = Inte_GPS_BoC_0_10;
            end
...
for i = 1:fmax
    hF = figure(hF+1);
    if (Signal_Type == BOCsin)
        pcolor((1:80)/8, (1:80)/8, BackInterSysJam_BoCsin_L2_BoC_0_10(1:80,1:80, i));
        xlabel('n')
        ylabel('m')
    elseif (Signal_Type == BOCcos)
        pcolor((1:80)/8, (1:80)/8, BackInterSysJam_BoCcos_L2_BoC_0_10(1:80,1:80, i));
        xlabel('n')
        ylabel('m')
    elseif (Signal_Type == BPSK)
        plot((1:80)/8, BackInterSysJam_BPSK_L2_BoC_0_10(1:80, i));        
        xlabel('n')
        ylabel('k_cd')
    end
